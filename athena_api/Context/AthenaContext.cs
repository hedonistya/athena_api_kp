...
{
  public partial class AthenaContext : ContextHelper
  {
    ...
    public AthenaContext(DbContextOptions<AthenaContext> options)
        : base("Server=sql5107.site4now.net;Database=db_a8415f_athena;User Id=db_a8415f_athena_admin;Password=1234Qwer#;Trusted_Connection=false;Integrated Security=false")
    {
    }
